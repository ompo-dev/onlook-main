  ...
  return (
    <div className={styles.gradientPicker}>
      ...
      <div className={styles.typeRow}>
        <select className={styles.typeSelect} value={config.type} onChange={(e) => handleTypeChange(e.target.value)}>
      ...
      {config.type === 'radial' && (
        <>
          <select className={styles.typeSelect} value={config.shape.startsWith('circle') ? 'circle' : 'ellipse'} onChange={(e) => handleShapeChange(e.target.value)}>
