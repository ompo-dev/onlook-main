// src/Editor/utils/css-shorthand.ts
var SHORTHAND_CONFIGS = [
...
function synthesizeShorthand(styles, shorthand, longhands) {
...
function synthesizeBorderShorthand(styles) {
  ...
  const allMatch = SIDES2.every(
    (side) => PARTS.every((p) => styles[`border-${side}-${p}`] === styles[`border-top-${p}`])
  );
  if (allMatch) {
