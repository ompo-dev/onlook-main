...
export class BranchManager {
    ...
    get activeBranchDataOrNull(): BranchData | null {
        if (!this.currentBranchId) {
            return null;
        }

        return this.branchMap.get(this.currentBranchId) ?? null;
    }

    get hasActiveBranch(): boolean {
        return this.activeBranchDataOrNull !== null;
    }
    ...
    get activeBranchOrNull(): Branch | null {
        return this.activeBranchDataOrNull?.branch ?? null;
    }
    ...
    get activeSandboxOrNull(): SandboxManager | null {
        return this.activeBranchDataOrNull?.sandbox ?? null;
    }
